...
${cmd} git cubew -b v4.6.0-rc1 https://gitlab.version.fz-juelich.de/perftools/cubew.git
${cmd} git cubelib -b v4.6.0-rc1 https://gitlab.version.fz-juelich.de/perftools/cubelib.git
