...
#else
    std::cerr << "ERROR: No Pthread support available on this system." << std::endl;
    // There may be Pthread support based on Pin available in the future.
    exit( EXIT_FAILURE );
#endif
